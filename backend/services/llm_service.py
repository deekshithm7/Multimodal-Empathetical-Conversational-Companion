...
class FreeLLMService:
    ...
    def generate_empathetic_response(
        ...
        if conversation_history:
            # Add last 20 messages for context (better long-term memory)
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "options": {
                        ...
                        "num_predict": 250,      # Max tokens (allow detailed responses)
                        "stop": ["\n\n", "User:", "Assistant:"]  # Stop sequences
                    }
                },
                timeout=45  # Increased timeout for chat responses
            )
...
Keep it personal and concise (under 150 words)."""
        ...
        try:
            response = requests.post(
                ...
                timeout=60  # Longer timeout for summaries
            )
