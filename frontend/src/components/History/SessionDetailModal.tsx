                        ...
                        <>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="bg-white/5 rounded-xl p-4 border border-white/10 text-center">
                                    <dt className="text-xs text-slate-500 mb-1 uppercase tracking-wider">Duration</dt>
                                    <dd className="text-2xl font-medium text-slate-200">
                                        {data.summary.ended_at && data.summary.started_at
                                            ...
                                            : 0} <span className="text-sm text-slate-500">min</span>
                                    </dd>
                                </div>
                                <div className="bg-white/5 rounded-xl p-4 border border-white/10 text-center">
                                    <dt className="text-xs text-slate-500 mb-1 uppercase tracking-wider">Messages</dt>
                                    <dd className="text-2xl font-medium text-slate-200">{data.summary.total_messages}</dd>
                                </div>
                                <div className="bg-white/5 rounded-xl p-4 border border-white/10 text-center">
                                    <dt className="text-xs text-slate-500 mb-1 uppercase tracking-wider">Status</dt>
                                    <dd className="capitalize text-slate-200 text-sm pt-1">{data.summary.status}</dd>
                                </div>
                            </div>

                            {/* Emotion Timeline — fixed pixel height so Recharts can measure */}
                            <div className="bg-white/5 rounded-xl px-4 pt-4 pb-2 border border-white/10">
                                <h3 className="text-sm font-medium text-slate-400 uppercase tracking-wider mb-2">Emotion Timeline</h3>
                                <div style={{ height: 200 }}>
                                    <EmotionTimeline
                                        compact
                                        data={(data.emotion_timeline || [])
                            ...
                            {/* Transcript */}
                            <div className="bg-white/5 rounded-xl border border-white/10 flex flex-col" style={{ maxHeight: '420px' }}>
