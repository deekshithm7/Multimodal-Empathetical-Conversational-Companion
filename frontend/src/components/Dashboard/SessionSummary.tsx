...
export const SessionSummary = ({ onClose, onStartNewSession }: SessionSummaryProps) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-3 justify-center">
                <button
                    onClick={onClose}
                    className="px-6 py-2 bg-white/10 hover:bg-white/20 text-slate-300 rounded-full transition-colors text-sm"
                >
                    Close & Review
                </button>
                <button
                    onClick={onStartNewSession}
                    className="px-6 py-2 bg-teal-500 hover:bg-teal-400 text-white font-medium rounded-full transition-colors shadow-lg shadow-teal-500/20 text-sm"
                >
                    Start New Session
                </button>
            </div>
