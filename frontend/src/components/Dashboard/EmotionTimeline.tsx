...
export interface EmotionTimelineProps {
    ...
    /** When true: hides the built-in title/legend and removes min-h so a parent can control height */
    compact?: boolean;
}
...
export const EmotionTimeline = ({ data, compact = false }: EmotionTimelineProps) => {
    ...
    return (
        <div className="w-full h-full flex flex-col">
            ...
            {/* Chart — min-h only in full mode; in compact the parent controls the height */}
            <div className={compact ? 'flex-1 w-full min-w-0' : 'flex-1 min-h-[300px] w-full min-w-0'}>
